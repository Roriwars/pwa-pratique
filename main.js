...
function loadTechnologies(technos) {
    fetch('https://us-central1-pwa-technos-camagny.cloudfunctions.net/getTechnos')
    .then(response => {
            response.json()
                .then(technos => {
...
if(navigator.serviceWorker) {
    ...
    .then(registration =>{
        ...
        const publicKey = "BD-Y-4bQylNcjSLt1yaHPvV7zi3XLbCpVvY0RTW6Sccody_ziTbm9u6-PAEie99QEMn0REdPP-uNhbucFIVCJos";
